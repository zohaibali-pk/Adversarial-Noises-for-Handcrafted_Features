%% Develepor's Information:
    ...
    %%% National University of Sciences & Technology, Islamabad %%%
        ...
        %%% Website: http://romi.seecs.nust.edu.pk/index.html %%%
                        %%% July 2019 %%%
%% Noise Type: Average Squared Mask (ASM) Perturbation:
clc 
clear
close all
...
%% Inpainting Section
        ...
        img_name_2 = fullfile(myFolder, 'Noisy_ASM.png') 
